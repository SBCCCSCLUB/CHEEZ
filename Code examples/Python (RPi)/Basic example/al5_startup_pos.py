...
sp.write("#0 P2000\r".encode())
sp.write("#1 P2000\r".encode())
sp.write("#2 P2000\r".encode())
sp.write("#3 P2000\r".encode())
sp.write("#4 P2000\r".encode())
sp.write("#5 P2000\r".encode())
